...
export const rolexData = {
    meta: {
        title: "Sell Rolex NYC | Top Cash for Rolex | InstaGold",
        description: "Sell your Rolex in NYC at our licensed 47th St location. Top cash for Submariner, Datejust, Daytona and all models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in NYC",
        image: {
            title: "rolex-hero",
            alt: "Rolex Submariner, Datejust and Daytona watches on stone at the InstaGold 47th Street office",
        },
        ...
        steps: [
            {
                ...
                body: "Submit the form or walk in and tell us which Rolex you have.",
            },
            {
                title: "Free Authentication",
                body: "We authenticate, inspect, and value your Rolex in front of you.",
            },
            {
    ...
    companyDetails: {
        ...
        title: "Why Sell Your Rolex to InstaGold",
        description: "We make selling a Rolex simple, fair, and fast.",
        items: [
            {
                icon: BadgeCheck,
            ...
            {
                icon: LineChart,
                title: "Real Market Offers",
                body: "Priced against current resale and auction data, tracked daily.",
            },
            {
                icon: MapPin,
        ...
        items: [
            {
                ...
                body: "All references, date and no-date.",
            },
            {
                icon: Sparkles,
                title: "Rolex Datejust and Day-Date",
                body: "Steel, two-tone, and precious metal.",
            },
            {
                icon: Gauge,
                title: "Rolex Daytona and GMT-Master",
                body: "Sports and racing chronographs.",
            },
            {
                icon: ShieldCheck,
                title: "Vintage and Rare Rolex",
                body: "Explorer, Sea-Dweller, and discontinued references.",
            },
        ],
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Rolex in NYC",
        description: "InstaGold is located at 31 W 47th Street in the heart of the Diamond District, the most trusted place to sell a Rolex in New York. We buy from sellers across Manhattan and the greater NYC area. Walk in during business hours or get an offer online first.",
        list: [
    ...
    testimonials: [
        {
            quote: "Sold my Submariner and got a better offer than the online buyers quoted. They checked it over in front of me and paid the same visit. Smooth and professional.",
            name: "James Thornton",
            item: "Rolex Submariner",
        },
        {
            quote: "I had a Datejust with no box or papers and thought that would be a problem. It was not. They valued it fairly and I walked out with cash.",
        ...
        },
        {
            ...
            item: "Rolex GMT-Master",
        },
        {
            quote: "They knew exactly what my vintage Explorer was worth and priced it against real auction results. No lowball, no games, just a fair number.",
            name: "Kevin Matthews",
            item: "Vintage Rolex Explorer",
        },
        {
            quote: "Fast, fair, and knowledgeable. They authenticated my Daytona on the spot and the payout matched the market. Exactly how it should be.",
            name: "Daniel Rosen",
            item: "Rolex Daytona",
        },
    ],
    ...
    faqs: [
        {
            q: "How much can I get for my Rolex?",
            a: "It depends on the model and reference, the condition and service history, the originality of the parts, and current collector demand. We price against real-time resale and auction data and explain how the offer is determined.",
        },
        {
            q: "Do you buy a Rolex without box and papers?",
            a: "Yes. Box and papers add value, but we buy Rolex watches with or without them.",
        },
        {
            q: "Do you buy non-working or damaged Rolex watches?",
            a: "Yes. We buy Rolex watches that are scratched, not running, or in need of service, and price them fairly.",
        },
        {
