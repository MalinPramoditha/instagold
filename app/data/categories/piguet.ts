...
// Audemars Piguet hub page - route: /sell-audemars-piguet-nyc
export const audemarsPiguetData = {
    meta: {
        title: "Sell Audemars Piguet NYC | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in NYC at our licensed 47th St buyer. Top cash for Audemars Piguet, valued by experts, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in NYC",
        image: {
            title: "audemars-piguet-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office",
        },
        description: "Sell your Audemars Piguet in NYC the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    offerForm: {
    ...
    companyDetails: {
        ...
        title: "Why Sell Your Audemars Piguet to InstaGold",
        description: "We make selling a Audemars Piguet simple, fair, and fast.",
        items: [
    ...
    location: {
        align: "right",
        tone: "white",
        image: { title: "audemars-piguet-end", alt: "InstaGold specialist authenticating a Audemars Piguet at the 47th Street Diamond District office" },
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet in NYC",
        description: "InstaGold is located at 31 W 47th Street in the heart of the Diamond District, the most trusted place to sell a Audemars Piguet in New York. We buy from sellers across Manhattan and the greater NYC area. Walk in during business hours or get an offer online first.",
        list: [
    ...
    testimonials: [
        ...
        { quote: "It's not common to be treated with respect in the Diamond District. How refreshing it was to meet the InstaGold team, who took care of all my needs with no pressure. This is definitely the place you'd like to visit.", name: "Przemysław Prusinowski", item: "Audemars Piguet" },
    ...
    faqs: [
        { q: "How much can I get for my Audemars Piguet?", a: "It depends on the model and reference, the condition and service history, the originality of the parts, and current collector demand. We price against real-time resale and auction data and explain how the offer is determined." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet Today",
