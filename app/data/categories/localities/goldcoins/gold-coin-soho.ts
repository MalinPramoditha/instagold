...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/soho
export const goldCoinSohoData = {
    meta: {
        title: "Gold Coin Buyers SoHo | Top Payouts | InstaGold",
        description: "Gold coin buyers serving SoHo. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/soho",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near SoHo",
    ...
    faqs: [
        { q: "Do you buy gold coins from SoHo sellers?", a: "Yes. SoHo is a short ride from SoHo up to the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
