...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/hoboken
export const goldCoinHobokenData = {
    meta: {
        title: "Gold Coin Buyers Hoboken | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Hoboken. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/hoboken",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Hoboken",
    ...
    faqs: [
        { q: "Do you buy gold coins from Hoboken sellers?", a: "Yes. Hoboken is a quick PATH ride from Hoboken into Manhattan and the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
