...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/upper-east-side
export const goldCoinUpperEastSideData = {
    meta: {
        title: "Gold Coin Buyers Upper East Side | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Upper East Side. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/upper-east-side",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving Upper East Side",
        image: {
            title: "gold-coins-upper-east-side-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving Upper East Side",
        },
        description: "Gold coin buyers serving Upper East Side do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. From the Upper East Side, our 47th Street office is a short ride down, so you can sell in person and get a fair, same-day offer. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Upper East Side",
    ...
    faqs: [
        { q: "Do you buy gold coins from Upper East Side sellers?", a: "Yes. Upper East Side is a direct ride from the Upper East Side down to the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
