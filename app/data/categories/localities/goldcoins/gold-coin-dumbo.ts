...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/dumbo
export const goldCoinDumboData = {
    meta: {
        title: "Gold Coin Buyers DUMBO | Top Payouts | InstaGold",
        description: "Gold coin buyers serving DUMBO. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/dumbo",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving DUMBO",
        image: {
            title: "gold-coins-dumbo-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving DUMBO",
        },
        description: "Gold coin buyers serving DUMBO do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. From DUMBO, our 47th Street office is a quick ride across the river, so you can sell in person instead of mailing it, and get paid the same day. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near DUMBO",
    ...
    faqs: [
        { q: "Do you buy gold coins from DUMBO sellers?", a: "Yes. DUMBO is a short subway ride from DUMBO into Manhattan and the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
