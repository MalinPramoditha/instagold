...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/upper-west-side
export const goldCoinUpperWestSideData = {
    meta: {
        title: "Gold Coin Buyers Upper West Side | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Upper West Side. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/upper-west-side",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Upper West Side",
    ...
    faqs: [
        { q: "Do you buy gold coins from Upper West Side sellers?", a: "Yes. Upper West Side is a direct ride from the Upper West Side down to the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
