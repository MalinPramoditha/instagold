...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/murray-hill
export const goldCoinMurrayHillData = {
    meta: {
        title: "Gold Coin Buyers Murray Hill | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Murray Hill. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/murray-hill",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving Murray Hill",
        image: {
            title: "gold-coins-murray-hill-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving Murray Hill",
        },
        description: "Gold coin buyers serving Murray Hill do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. Murray Hill is close to our 47th Street office, so selling in person is quick and you get a fair, same-day offer. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Murray Hill",
    ...
    faqs: [
        { q: "Do you buy gold coins from Murray Hill sellers?", a: "Yes. Murray Hill is minutes from Murray Hill. Bring your coins in for a free, same-day offer, or get a quote online first." },
