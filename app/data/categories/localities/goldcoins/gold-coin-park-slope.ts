...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/park-slope
export const goldCoinParkSlopeData = {
    meta: {
        title: "Gold Coin Buyers Park Slope | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Park Slope. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/park-slope",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving Park Slope",
        image: {
            title: "gold-coins-park-slope-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving Park Slope",
        },
        description: "Gold coin buyers serving Park Slope do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. From Park Slope, our 47th Street office is a direct ride into Manhattan, so you can sell in person and get paid the same day. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Park Slope",
    ...
    faqs: [
        { q: "Do you buy gold coins from Park Slope sellers?", a: "Yes. Park Slope is a direct subway ride from Park Slope into Manhattan and the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
