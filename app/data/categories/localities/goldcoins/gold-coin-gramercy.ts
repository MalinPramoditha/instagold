...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/gramercy
export const goldCoinGramercyData = {
    meta: {
        title: "Gold Coin Buyers Gramercy | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Gramercy. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/gramercy",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Gramercy",
    ...
    faqs: [
        { q: "Do you buy gold coins from Gramercy sellers?", a: "Yes. Gramercy is a short ride from Gramercy up to the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
