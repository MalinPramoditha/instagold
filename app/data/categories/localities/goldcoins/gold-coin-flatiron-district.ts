...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/flatiron-district
export const goldCoinFlatironDistrictData = {
    meta: {
        title: "Gold Coin Buyers Flatiron District | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Flatiron District. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/flatiron-district",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Flatiron District",
    ...
    faqs: [
        { q: "Do you buy gold coins from Flatiron District sellers?", a: "Yes. Flatiron District is minutes from the Flatiron District. Bring your coins in for a free, same-day offer, or get a quote online first." },
