...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/long-island-city
export const goldCoinLongIslandCityData = {
    meta: {
        title: "Gold Coin Buyers Long Island City | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Long Island City. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Long Island City",
    ...
    faqs: [
        { q: "Do you buy gold coins from Long Island City sellers?", a: "Yes. Long Island City is a short subway ride from Long Island City into Midtown and the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
