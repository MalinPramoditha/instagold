...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/west-village
export const goldCoinWestVillageData = {
    meta: {
        title: "Gold Coin Buyers West Village | Top Payouts | InstaGold",
        description: "Gold coin buyers serving West Village. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/west-village",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving West Village",
        image: {
            title: "gold-coins-west-village-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving West Village",
        },
        description: "Gold coin buyers serving West Village do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. From the West Village, our 47th Street office is a quick trip uptown, so you can sell in person and get a fair, same-day offer. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near West Village",
    ...
    faqs: [
        { q: "Do you buy gold coins from West Village sellers?", a: "Yes. West Village is a short ride from the West Village up to the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
