...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/chelsea
export const goldCoinChelseaData = {
    meta: {
        title: "Gold Coin Buyers Chelsea | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Chelsea. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/chelsea",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Chelsea",
    ...
    faqs: [
        { q: "Do you buy gold coins from Chelsea sellers?", a: "Yes. Chelsea is minutes from Chelsea. Bring your coins in for a free, same-day offer, or get a quote online first." },
