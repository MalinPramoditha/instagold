...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/downtown-jersey-city
export const goldCoinDowntownJerseyCityData = {
    meta: {
        title: "Gold Coin Buyers Downtown Jersey City | InstaGold",
        description: "Gold coin buyers serving Downtown Jersey City. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/downtown-jersey-city",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving Downtown Jersey City",
        image: {
            title: "gold-coins-downtown-jersey-city-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving Downtown Jersey City",
        },
        description: "Gold coin buyers serving Downtown Jersey City do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. From Downtown Jersey City, our 47th Street office is a quick PATH ride into Manhattan, so you can sell in person and get a fair, same-day offer. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Downtown Jersey City",
    ...
    faqs: [
        { q: "Do you buy gold coins from Downtown Jersey City sellers?", a: "Yes. Downtown Jersey City is a quick PATH ride from Downtown Jersey City into Manhattan and the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
