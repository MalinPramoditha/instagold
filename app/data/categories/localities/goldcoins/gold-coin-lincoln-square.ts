...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/lincoln-square
export const goldCoinLincolnSquareData = {
    meta: {
        title: "Gold Coin Buyers Lincoln Square | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Lincoln Square. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/lincoln-square",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Lincoln Square",
    ...
    faqs: [
        { q: "Do you buy gold coins from Lincoln Square sellers?", a: "Yes. Lincoln Square is a direct ride from Lincoln Square. Bring your coins in for a free, same-day offer, or get a quote online first." },
