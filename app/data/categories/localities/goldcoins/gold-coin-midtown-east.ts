...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/midtown-east
export const goldCoinMidtownEastData = {
    meta: {
        title: "Gold Coin Buyers Midtown East | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Midtown East. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Midtown East",
    ...
    faqs: [
        { q: "Do you buy gold coins from Midtown East sellers?", a: "Yes. Midtown East is a few blocks from Midtown East. Bring your coins in for a free, same-day offer, or get a quote online first." },
