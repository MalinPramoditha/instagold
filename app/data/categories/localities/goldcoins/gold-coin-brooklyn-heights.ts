...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/brooklyn-heights
export const goldCoinBrooklynHeightsData = {
    meta: {
        title: "Gold Coin Buyers Brooklyn Heights | Top Payouts | InstaGold",
        description: "Gold coin buyers serving Brooklyn Heights. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/brooklyn-heights",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving Brooklyn Heights",
        image: {
            title: "gold-coins-brooklyn-heights-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving Brooklyn Heights",
        },
        description: "Gold coin buyers serving Brooklyn Heights do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. From Brooklyn Heights, our 47th Street office is a quick ride across the river, so you can sell in person and get a fair, same-day offer. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Brooklyn Heights",
    ...
    faqs: [
        { q: "Do you buy gold coins from Brooklyn Heights sellers?", a: "Yes. Brooklyn Heights is a short subway ride from Brooklyn Heights into Manhattan and the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
