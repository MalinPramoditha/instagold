...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/nomad
export const goldCoinNomadData = {
    meta: {
        title: "Gold Coin Buyers NoMad | Top Payouts | InstaGold",
        description: "Gold coin buyers serving NoMad. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/nomad",
    ...
    hero: {
        ...
        title: "Gold Coin Buyers Serving NoMad",
        image: {
            title: "gold-coins-nomad-hero",
            alt: "Gold coins including Krugerrands and Eagles on stone at the InstaGold 47th Street office, serving NoMad",
        },
        description: "Gold coin buyers serving NoMad do not come more trusted than InstaGold. We are a licensed buyer on 47th Street in the Diamond District, paying top rates for bullion and rare gold coins. NoMad is a short walk or ride from our 47th Street office, so you can sell in person, watch the evaluation, and get paid the same day. We test, weigh, and value your coins in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near NoMad",
    ...
    faqs: [
        { q: "Do you buy gold coins from NoMad sellers?", a: "Yes. NoMad is minutes from NoMad. Bring your coins in for a free, same-day offer, or get a quote online first." },
