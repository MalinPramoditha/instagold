...
// Gold Coins locality page - route: /gold-coin-buyers-nyc/financial-district
export const goldCoinFinancialDistrictData = {
    meta: {
        title: "Gold Coin Buyers Financial District | InstaGold",
        description: "Gold coin buyers serving Financial District. Top rates for Krugerrands, Eagles and rare coins at our licensed 47th St location. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/gold-coin-buyers-nyc/financial-district",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Coins Near Financial District",
    ...
    faqs: [
        { q: "Do you buy gold coins from Financial District sellers?", a: "Yes. Financial District is a direct subway ride from the Financial District and Wall Street up to the Diamond District. Bring your coins in for a free, same-day offer, or get a quote online first." },
