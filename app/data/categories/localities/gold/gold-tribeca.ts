...
// Cash for Gold locality page - route: /cash-for-gold-nyc/tribeca
export const goldTribecaData = {
    meta: {
        title: "Cash for Gold Tribeca | Same-Day Payout | InstaGold",
        description: "Cash for gold in Tribeca at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/tribeca",
    ...
    hero: {
        ...
        title: "Cash for Gold in Tribeca",
        image: {
            title: "cash-for-gold-tribeca-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving Tribeca sellers",
        },
        description: "Cash for gold in Tribeca starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. Tribeca sits just south of the Diamond District, so selling in person means no mailing, no waiting, and a real offer the same day. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Tribeca",
    ...
    faqs: [
        { q: "Do you buy gold from Tribeca sellers?", a: "Yes. Tribeca is a quick trip from Tribeca up to the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
