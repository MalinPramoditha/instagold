...
// Cash for Gold locality page - route: /cash-for-gold-nyc/hudson-yards
export const goldHudsonYardsData = {
    meta: {
        title: "Cash for Gold Hudson Yards | Same-Day Payout | InstaGold",
        description: "Cash for gold in Hudson Yards at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/hudson-yards",
    ...
    hero: {
        ...
        title: "Cash for Gold in Hudson Yards",
        image: {
            title: "cash-for-gold-hudson-yards-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving Hudson Yards sellers",
        },
        description: "Cash for gold in Hudson Yards starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. Hudson Yards is a short ride from our 47th Street office, so you can sell in person and get a fair, same-day offer. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Hudson Yards",
    ...
    faqs: [
        { q: "Do you buy gold from Hudson Yards sellers?", a: "Yes. Hudson Yards is minutes from Hudson Yards. Bring your gold in for a free, same-day offer, or get a quote online first." },
