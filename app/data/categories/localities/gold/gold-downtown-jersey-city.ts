...
// Cash for Gold locality page - route: /cash-for-gold-nyc/downtown-jersey-city
export const goldDowntownJerseyCityData = {
    meta: {
        title: "Cash for Gold Downtown Jersey City | InstaGold",
        description: "Cash for gold in Downtown Jersey City. Licensed 47th St buyer, top payouts on gold jewelry, coins and bullion, paid same day.",
    },
    schema: [
        {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Downtown Jersey City",
    ...
    faqs: [
        { q: "Do you buy gold from Downtown Jersey City sellers?", a: "Yes. Downtown Jersey City is a quick PATH ride from Downtown Jersey City into Manhattan and the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
