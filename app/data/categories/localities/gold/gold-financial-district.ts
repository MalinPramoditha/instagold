...
// Cash for Gold locality page - route: /cash-for-gold-nyc/financial-district
export const goldFinancialDistrictData = {
    meta: {
        title: "Cash for Gold Financial District | InstaGold",
        description: "Cash for gold in Financial District at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/financial-district",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Financial District",
    ...
    faqs: [
        { q: "Do you buy gold from Financial District sellers?", a: "Yes. Financial District is a direct subway ride from the Financial District and Wall Street up to the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
