...
// Cash for Gold locality page - route: /cash-for-gold-nyc/brooklyn-heights
export const goldBrooklynHeightsData = {
    meta: {
        title: "Cash for Gold Brooklyn Heights | Same-Day Payout | InstaGold",
        description: "Cash for gold in Brooklyn Heights at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/brooklyn-heights",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Brooklyn Heights",
    ...
    faqs: [
        { q: "Do you buy gold from Brooklyn Heights sellers?", a: "Yes. Brooklyn Heights is a short subway ride from Brooklyn Heights into Manhattan and the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
