...
// Cash for Gold locality page - route: /cash-for-gold-nyc/flatiron-district
export const goldFlatironDistrictData = {
    meta: {
        title: "Cash for Gold Flatiron District | InstaGold",
        description: "Cash for gold in Flatiron District at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/flatiron-district",
    ...
    hero: {
        ...
        image: {
            title: "cash-for-gold-flatiron-district-hero",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Flatiron District",
    ...
    faqs: [
        { q: "Do you buy gold from Flatiron District sellers?", a: "Yes. Flatiron District is minutes from the Flatiron District. Bring your gold in for a free, same-day offer, or get a quote online first." },
