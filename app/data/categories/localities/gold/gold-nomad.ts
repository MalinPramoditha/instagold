...
// Cash for Gold locality page - route: /cash-for-gold-nyc/nomad
export const goldNomadData = {
    meta: {
        title: "Cash for Gold NoMad | Same-Day Payout | InstaGold",
        description: "Cash for gold in NoMad at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/nomad",
    ...
    hero: {
        ...
        image: {
            title: "cash-for-gold-nomad-hero",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near NoMad",
    ...
    faqs: [
        { q: "Do you buy gold from NoMad sellers?", a: "Yes. NoMad is minutes from NoMad. Bring your gold in for a free, same-day offer, or get a quote online first." },
