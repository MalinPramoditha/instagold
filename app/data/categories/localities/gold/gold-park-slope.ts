...
// Cash for Gold locality page - route: /cash-for-gold-nyc/park-slope
export const goldParkSlopeData = {
    meta: {
        title: "Cash for Gold Park Slope | Same-Day Payout | InstaGold",
        description: "Cash for gold in Park Slope at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/park-slope",
    ...
    hero: {
        ...
        title: "Cash for Gold in Park Slope",
        image: {
            title: "cash-for-gold-park-slope-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving Park Slope sellers",
        },
        description: "Cash for gold in Park Slope starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. From Park Slope, our 47th Street office is a direct ride into Manhattan, so you can sell in person and get paid the same day. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Park Slope",
    ...
    faqs: [
        { q: "Do you buy gold from Park Slope sellers?", a: "Yes. Park Slope is a direct subway ride from Park Slope into Manhattan and the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
