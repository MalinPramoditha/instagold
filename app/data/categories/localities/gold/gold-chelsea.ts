...
// Cash for Gold locality page - route: /cash-for-gold-nyc/chelsea
export const goldChelseaData = {
    meta: {
        title: "Cash for Gold Chelsea | Same-Day Payout | InstaGold",
        description: "Cash for gold in Chelsea at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/chelsea",
    ...
    hero: {
        ...
        image: {
            title: "cash-for-gold-chelsea-hero",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Chelsea",
    ...
    faqs: [
        { q: "Do you buy gold from Chelsea sellers?", a: "Yes. Chelsea is minutes from Chelsea. Bring your gold in for a free, same-day offer, or get a quote online first." },
