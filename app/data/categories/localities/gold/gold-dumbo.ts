...
// Cash for Gold locality page - route: /cash-for-gold-nyc/dumbo
export const goldDumboData = {
    meta: {
        title: "Cash for Gold DUMBO | Same-Day Payout | InstaGold",
        description: "Cash for gold in DUMBO at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/dumbo",
    ...
    hero: {
        ...
        title: "Cash for Gold in DUMBO",
        image: {
            title: "cash-for-gold-dumbo-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving DUMBO sellers",
        },
        description: "Cash for gold in DUMBO starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. From DUMBO, our 47th Street office is a quick ride across the river, so you can sell in person instead of mailing it, and get paid the same day. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near DUMBO",
    ...
    faqs: [
        { q: "Do you buy gold from DUMBO sellers?", a: "Yes. DUMBO is a short subway ride from DUMBO into Manhattan and the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
