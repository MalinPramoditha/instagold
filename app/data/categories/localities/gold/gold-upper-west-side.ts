...
// Cash for Gold locality page - route: /cash-for-gold-nyc/upper-west-side
export const goldUpperWestSideData = {
    meta: {
        title: "Cash for Gold Upper West Side | Same-Day Payout | InstaGold",
        description: "Cash for gold in Upper West Side at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/upper-west-side",
    ...
    hero: {
        ...
        title: "Cash for Gold in Upper West Side",
        image: {
            title: "cash-for-gold-upper-west-side-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving Upper West Side sellers",
        },
        description: "Cash for gold in Upper West Side starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. From the Upper West Side, our 47th Street office is a straight ride down, so you can sell in person and get a fair, same-day offer. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Upper West Side",
    ...
    faqs: [
        { q: "Do you buy gold from Upper West Side sellers?", a: "Yes. Upper West Side is a direct ride from the Upper West Side down to the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
