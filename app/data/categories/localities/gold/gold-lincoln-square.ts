...
// Cash for Gold locality page - route: /cash-for-gold-nyc/lincoln-square
export const goldLincolnSquareData = {
    meta: {
        title: "Cash for Gold Lincoln Square | Same-Day Payout | InstaGold",
        description: "Cash for gold in Lincoln Square at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/lincoln-square",
    ...
    hero: {
        ...
        title: "Cash for Gold in Lincoln Square",
        image: {
            title: "cash-for-gold-lincoln-square-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving Lincoln Square sellers",
        },
        description: "Cash for gold in Lincoln Square starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. From Lincoln Square, our 47th Street office is a straight ride down, so you can sell in person and get a fair, same-day offer. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Lincoln Square",
    ...
    faqs: [
        { q: "Do you buy gold from Lincoln Square sellers?", a: "Yes. Lincoln Square is a direct ride from Lincoln Square. Bring your gold in for a free, same-day offer, or get a quote online first." },
