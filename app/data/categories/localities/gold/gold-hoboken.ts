...
// Cash for Gold locality page - route: /cash-for-gold-nyc/hoboken
export const goldHobokenData = {
    meta: {
        title: "Cash for Gold Hoboken | Same-Day Payout | InstaGold",
        description: "Cash for gold in Hoboken at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/hoboken",
    ...
    hero: {
        ...
        title: "Cash for Gold in Hoboken",
        image: {
            title: "cash-for-gold-hoboken-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving Hoboken sellers",
        },
        description: "Cash for gold in Hoboken starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. From Hoboken, our 47th Street office is a quick PATH ride into Manhattan, so you can sell in person instead of mailing it, and get a fair, same-day offer. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Hoboken",
    ...
    faqs: [
        { q: "Do you buy gold from Hoboken sellers?", a: "Yes. Hoboken is a quick PATH ride from Hoboken into Manhattan and the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
