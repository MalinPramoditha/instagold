...
// Cash for Gold locality page - route: /cash-for-gold-nyc/midtown-east
export const goldMidtownEastData = {
    meta: {
        title: "Cash for Gold Midtown East | Same-Day Payout | InstaGold",
        description: "Cash for gold in Midtown East at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/midtown-east",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Midtown East",
    ...
    faqs: [
        { q: "Do you buy gold from Midtown East sellers?", a: "Yes. Midtown East is a few blocks from Midtown East. Bring your gold in for a free, same-day offer, or get a quote online first." },
