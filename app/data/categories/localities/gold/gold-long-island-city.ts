...
// Cash for Gold locality page - route: /cash-for-gold-nyc/long-island-city
export const goldLongIslandCityData = {
    meta: {
        title: "Cash for Gold Long Island City | Same-Day Payout | InstaGold",
        description: "Cash for gold in Long Island City at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/long-island-city",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Long Island City",
    ...
    faqs: [
        { q: "Do you buy gold from Long Island City sellers?", a: "Yes. Long Island City is a short subway ride from Long Island City into Midtown and the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
