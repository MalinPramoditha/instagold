...
// Cash for Gold locality page - route: /cash-for-gold-nyc/west-village
export const goldWestVillageData = {
    meta: {
        title: "Cash for Gold West Village | Same-Day Payout | InstaGold",
        description: "Cash for gold in West Village at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
    ...
    hero: {
        ...
        title: "Cash for Gold in West Village",
        image: {
            title: "cash-for-gold-west-village-hero",
            alt: "Gold jewelry, coins and bullion on stone at the InstaGold 47th Street office, serving West Village sellers",
        },
        description: "Cash for gold in West Village starts here. InstaGold is a licensed gold buyer on 47th Street in the Diamond District, paying top rates for gold jewelry, coins, and bullion. From the West Village, our 47th Street office is a quick trip uptown, so you can sell in person and get a fair, same-day offer. We test and weigh your gold in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near West Village",
    ...
    faqs: [
        { q: "Do you buy gold from West Village sellers?", a: "Yes. West Village is a short ride from the West Village up to the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
