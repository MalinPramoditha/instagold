...
// Cash for Gold locality page - route: /cash-for-gold-nyc/soho
export const goldSohoData = {
    meta: {
        title: "Cash for Gold SoHo | Same-Day Payout | InstaGold",
        description: "Cash for gold in SoHo at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near SoHo",
    ...
    faqs: [
        { q: "Do you buy gold from SoHo sellers?", a: "Yes. SoHo is a short ride from SoHo up to the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
