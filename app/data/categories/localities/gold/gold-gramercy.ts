...
// Cash for Gold locality page - route: /cash-for-gold-nyc/gramercy
export const goldGramercyData = {
    meta: {
        title: "Cash for Gold Gramercy | Same-Day Payout | InstaGold",
        description: "Cash for gold in Gramercy at InstaGold, a licensed 47th St buyer. Top payouts on gold jewelry, coins and bullion, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/cash-for-gold-nyc/gramercy",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell Gold Near Gramercy",
    ...
    faqs: [
        { q: "Do you buy gold from Gramercy sellers?", a: "Yes. Gramercy is a short ride from Gramercy up to the Diamond District. Bring your gold in for a free, same-day offer, or get a quote online first." },
