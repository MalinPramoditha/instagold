...
// Rolex locality page - route: /sell-rolex-nyc/dumbo
export const rolexDumboData = {
    meta: {
        title: "Sell Rolex DUMBO | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in DUMBO with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
    ...
    hero: {
        ...
        title: "Sell Your Rolex in DUMBO",
        image: {
            title: "rolex-dumbo-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving DUMBO sellers",
        },
        description: "Selling a Rolex from DUMBO is simple with InstaGold. We are a licensed Rolex buyer across the river on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Do you buy Rolex watches from DUMBO, Brooklyn?", a: "Yes. DUMBO is a short subway ride from our 47th Street office. Come in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Rolex in DUMBO Today",
