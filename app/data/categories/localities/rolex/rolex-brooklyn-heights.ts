...
// Rolex locality page - route: /sell-rolex-nyc/brooklyn-heights
export const rolexBrooklynHeightsData = {
    meta: {
        title: "Sell Rolex Brooklyn Heights | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Brooklyn Heights with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/brooklyn-heights",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Rolex Near Brooklyn Heights",
        description: "From Brooklyn Heights, our 47th Street office is a quick ride across the river, so you can sell your Rolex in person and get a fair, same-day offer. InstaGold is a short subway ride from Brooklyn Heights into Manhattan and the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
    ...
    faqs: [
        { q: "Can I sell my Rolex from Brooklyn Heights?", a: "Yes. Brooklyn Heights is a short subway ride from our 47th Street office. Walk in for a free appraisal, or start with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Brooklyn Heights Today",
