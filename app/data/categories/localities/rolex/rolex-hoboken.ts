...
// Rolex locality page - route: /sell-rolex-nyc/hoboken
export const rolexHobokenData = {
    meta: {
        title: "Sell Rolex Hoboken | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Hoboken with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/hoboken",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Hoboken",
        image: {
            title: "rolex-hoboken-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Hoboken sellers",
        },
        description: "Selling a Rolex from Hoboken is simple with InstaGold. We are a licensed Rolex buyer across the river on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Do you buy Rolex watches from Hoboken, NJ?", a: "Yes. Hoboken is a quick PATH ride from our 47th Street office. Come in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Rolex in Hoboken Today",
