...
// Rolex locality page - route: /sell-rolex-nyc/lincoln-square
export const rolexLincolnSquareData = {
    meta: {
        title: "Sell Rolex Lincoln Square | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Lincoln Square with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/lincoln-square",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Lincoln Square",
        image: {
            title: "rolex-lincoln-square-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Lincoln Square sellers",
        },
        description: "Selling a Rolex in Lincoln Square is easy with InstaGold. We are a licensed Rolex buyer downtown on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Can I sell my Rolex near Lincoln Square?", a: "Yes. Lincoln Square is a direct ride to our 47th Street office. Walk in for a free appraisal, or begin with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Lincoln Square Today",
