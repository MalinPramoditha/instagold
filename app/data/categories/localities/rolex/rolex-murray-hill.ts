...
// Rolex locality page - route: /sell-rolex-nyc/murray-hill
export const rolexMurrayHillData = {
    meta: {
        title: "Sell Rolex Murray Hill | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Murray Hill with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/murray-hill",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Murray Hill",
        image: {
            title: "rolex-murray-hill-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Murray Hill sellers",
        },
        description: "Selling a Rolex in Murray Hill is simple with InstaGold. We are a licensed Rolex buyer a short ride away on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Do you buy Rolex watches from Murray Hill?", a: "Yes. Murray Hill is minutes from our 47th Street office. Come in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Rolex in Murray Hill Today",
