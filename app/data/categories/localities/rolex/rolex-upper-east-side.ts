...
// Rolex locality page - route: /sell-rolex-nyc/upper-east-side
export const rolexUpperEastSideData = {
    meta: {
        title: "Sell Rolex Upper East Side | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Upper East Side with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Upper East Side",
        image: {
            title: "rolex-upper-east-side-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Upper East Side sellers",
        },
        description: "Selling a Rolex on the Upper East Side is easy with InstaGold. We are a licensed Rolex buyer a short ride away on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Rolex Near Upper East Side",
        description: "From the Upper East Side, our 47th Street office is a short ride down, so you can sell your Rolex in person and get a fair, same-day offer. InstaGold is a direct ride from the Upper East Side down to the Diamond District, near Fifth Avenue. Walk in during business hours or get an offer online first.",
        list: [
    ...
    faqs: [
        { q: "Can I sell my Rolex near the Upper East Side?", a: "Yes. The Upper East Side is a direct ride to our 47th Street office. Walk in for a free appraisal, or begin with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Upper East Side Today",
