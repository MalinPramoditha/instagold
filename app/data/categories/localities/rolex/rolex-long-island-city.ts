...
// Rolex locality page - route: /sell-rolex-nyc/long-island-city
export const rolexLongIslandCityData = {
    meta: {
        title: "Sell Rolex Long Island City | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Long Island City with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/long-island-city",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Long Island City",
        image: {
            title: "rolex-long-island-city-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Long Island City sellers",
        },
        description: "Selling a Rolex from Long Island City is easy with InstaGold. We are a licensed Rolex buyer a short ride away on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Rolex Near Long Island City",
        description: "From Long Island City, our 47th Street office is a quick ride into Midtown, so you can sell your Rolex in person on your schedule and get paid the same day. InstaGold is a short subway ride from Long Island City into Midtown and the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
    ...
    faqs: [
        { q: "Can I sell my Rolex from Long Island City?", a: "Yes. Long Island City is a short subway ride from our 47th Street office. Walk in for a free appraisal, or begin with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Long Island City Today",
