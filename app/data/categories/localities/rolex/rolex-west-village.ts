...
// Rolex locality page - route: /sell-rolex-nyc/west-village
export const rolexWestVillageData = {
    meta: {
        title: "Sell Rolex West Village | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in West Village with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/west-village",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in West Village",
        image: {
            title: "rolex-west-village-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving West Village sellers",
        },
        description: "Selling a Rolex in the West Village is easy with InstaGold. We are a licensed Rolex buyer uptown on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Rolex Near West Village",
        description: "From the West Village, our 47th Street office is a quick trip uptown, so you can sell your Rolex in person and get a fair, same-day offer. InstaGold is a short ride from the West Village up to the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
    ...
    faqs: [
        { q: "Can I sell my Rolex near the West Village?", a: "Yes. The West Village is a short ride from our 47th Street office. Walk in for a free appraisal, or start with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in West Village Today",
