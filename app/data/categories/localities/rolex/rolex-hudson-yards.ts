...
// Rolex locality page - route: /sell-rolex-nyc/hudson-yards
export const rolexHudsonYardsData = {
    meta: {
        title: "Sell Rolex Hudson Yards | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Hudson Yards with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/hudson-yards",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Hudson Yards",
        image: {
            title: "rolex-hudson-yards-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Hudson Yards sellers",
        },
        description: "Selling a Rolex in Hudson Yards is simple with InstaGold. We are a licensed Rolex buyer across town on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Do you buy Rolex watches from Hudson Yards?", a: "Yes. Hudson Yards is minutes from our 47th Street office. Come in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Rolex in Hudson Yards Today",
