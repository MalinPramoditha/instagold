...
// Rolex locality page - route: /sell-rolex-nyc/gramercy
export const rolexGramercyData = {
    meta: {
        title: "Sell Rolex Gramercy | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Gramercy with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/gramercy",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Gramercy",
        image: {
            title: "rolex-gramercy-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Gramercy sellers",
        },
        description: "Selling a Rolex in Gramercy is easy with InstaGold. We are a licensed Rolex buyer just north on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Can I sell my Rolex near Gramercy?", a: "Yes. Gramercy is a short ride from our 47th Street office. Walk in for a free appraisal, or start with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Gramercy Today",
