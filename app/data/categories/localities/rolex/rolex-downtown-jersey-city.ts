...
// Rolex locality page - route: /sell-rolex-nyc/downtown-jersey-city
export const rolexDowntownJerseyCityData = {
    meta: {
        title: "Sell Rolex Downtown Jersey City | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Downtown Jersey City with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/downtown-jersey-city",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Downtown Jersey City",
        image: {
            title: "rolex-downtown-jersey-city-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Downtown Jersey City sellers",
        },
        description: "Selling a Rolex from Downtown Jersey City is easy with InstaGold. We are a licensed Rolex buyer across the river on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Can I sell my Rolex from Downtown Jersey City?", a: "Yes. Downtown Jersey City is a quick PATH ride from our 47th Street office. Walk in for a free appraisal, or start with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Downtown Jersey City Today",
