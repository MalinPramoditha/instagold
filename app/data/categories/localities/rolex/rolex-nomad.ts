...
// Rolex locality page - route: /sell-rolex-nyc/nomad
export const rolexNomadData = {
    meta: {
        title: "Sell Rolex NoMad | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in NoMad with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/nomad",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in NoMad",
        image: {
            title: "rolex-nomad-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving NoMad sellers",
        },
        description: "Selling a Rolex in NoMad is simple with InstaGold. We are a licensed Rolex buyer a few blocks north on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Do you buy Rolex watches from NoMad?", a: "Yes. NoMad is minutes from our 47th Street office. Come in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Rolex in NoMad Today",
