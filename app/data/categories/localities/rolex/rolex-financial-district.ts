...
// Rolex locality page - route: /sell-rolex-nyc/financial-district
export const rolexFinancialDistrictData = {
    meta: {
        title: "Sell Rolex Financial District | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Financial District with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
    ...
    hero: {
        ...
        title: "Sell Your Rolex in Financial District",
        image: {
            title: "rolex-financial-district-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving Financial District sellers",
        },
        description: "Selling a Rolex in the Financial District is easy with InstaGold. We are a licensed Rolex buyer uptown on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Can I sell my Rolex near the Financial District?", a: "Yes. We are a straight ride uptown from the Financial District. Walk in for a free, same-day appraisal, or start with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in Financial District Today",
