...
// Rolex locality page - route: /sell-rolex-nyc/tribeca
export const rolexTribecaData = {
    meta: {
        title: "Sell Rolex Tribeca | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in Tribeca with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/tribeca",
    ...
    companyDetails: {
        ...
        description: "Tribeca residents value discretion and quality, and expect the same when they sell a watch.",
        items: [
    ...
    faqs: [
        { q: "Do you buy Rolex watches from Tribeca sellers?", a: "Yes. Tribeca is a short ride from our 47th Street office. Bring your Rolex in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Rolex in Tribeca Today",
