...
// Rolex locality page - route: /sell-rolex-nyc/soho
export const rolexSohoData = {
    meta: {
        title: "Sell Rolex SoHo | Top Cash NYC | InstaGold",
        description: "Sell your Rolex in SoHo with InstaGold. Licensed 47th St buyer paying top cash for all Rolex models, with or without papers. Paid same day.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-rolex-nyc/soho",
    ...
    hero: {
        ...
        title: "Sell Your Rolex in SoHo",
        image: {
            title: "rolex-soho-hero",
            alt: "Rolex watches on stone at the InstaGold 47th Street office, serving SoHo sellers",
        },
        description: "Selling a Rolex in SoHo is easy with InstaGold. We are a licensed Rolex buyer uptown on 47th Street in the Diamond District, paying top cash for every Rolex model, with or without box and papers. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    faqs: [
        { q: "Can I sell my Rolex near SoHo?", a: "Yes. SoHo is a short ride from our 47th Street office. Walk in for a free appraisal, or begin with an online offer." },
    ...
    cta: {
        title: "Sell Your Rolex in SoHo Today",
