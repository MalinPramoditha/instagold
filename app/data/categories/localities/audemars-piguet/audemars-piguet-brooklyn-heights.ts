...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/brooklyn-heights
export const audemarsPiguetBrooklynHeightsData = {
    meta: {
        title: "Sell Audemars Piguet Brooklyn Heights | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Brooklyn Heights with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/brooklyn-heights",
            ...
            areaServed: [
                { "@type": "Place", name: "Brooklyn Heights" },
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Brooklyn Heights",
        image: {
            title: "audemars-piguet-brooklyn-heights-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Brooklyn Heights sellers",
        },
        description: "Sell your Audemars Piguet in Brooklyn Heights the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From Brooklyn Heights, our 47th Street office is a quick ride across the river, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Brooklyn Heights Sellers Choose InstaGold",
        description: "Brooklyn Heights sellers value a trustworthy buyer worth the short trip into Manhattan.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Brooklyn Heights",
        ...
        list: [
            ...
            "Serving Brooklyn Heights and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Brooklyn Heights sellers?", a: "Yes. Brooklyn Heights is a short subway ride from Brooklyn Heights into Manhattan and the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Brooklyn Heights Today",
