...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/nomad
export const audemarsPiguetNomadData = {
    meta: {
        title: "Sell Audemars Piguet NoMad | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in NoMad with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/nomad",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in NoMad",
        image: {
            title: "audemars-piguet-nomad-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving NoMad sellers",
        },
        description: "Sell your Audemars Piguet in NoMad the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. NoMad is a short walk or ride from our 47th Street office, so you can sell in person, watch the evaluation, and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why NoMad Sellers Choose InstaGold",
        description: "NoMad sits between Flatiron and Midtown, and sellers here expect competitive, market-based offers.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near NoMad",
        description: "NoMad is a short walk or ride from our 47th Street office, so you can sell in person, watch the evaluation, and get paid the same day. InstaGold is minutes from NoMad, near Madison Square Park and Bryant Park. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving NoMad and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from NoMad sellers?", a: "Yes. NoMad is minutes from NoMad. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in NoMad Today",
