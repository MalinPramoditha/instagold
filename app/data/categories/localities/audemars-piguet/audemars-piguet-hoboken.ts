...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/hoboken
export const audemarsPiguetHobokenData = {
    meta: {
        title: "Sell Audemars Piguet Hoboken | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Hoboken with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/hoboken",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Hoboken",
        image: {
            title: "audemars-piguet-hoboken-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Hoboken sellers",
        },
        description: "Sell your Audemars Piguet in Hoboken the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From Hoboken, our 47th Street office is a quick PATH ride into Manhattan, so you can sell in person instead of mailing it, and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Hoboken Sellers Choose InstaGold",
        description: "Hoboken sellers want a trustworthy buyer and a convenient trip into the city.",
        items: [
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Hoboken sellers?", a: "Yes. Hoboken is a quick PATH ride from Hoboken into Manhattan and the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Hoboken Today",
