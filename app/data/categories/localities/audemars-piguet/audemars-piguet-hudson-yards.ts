...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/hudson-yards
export const audemarsPiguetHudsonYardsData = {
    meta: {
        title: "Sell Audemars Piguet Hudson Yards | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Hudson Yards with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/hudson-yards",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Hudson Yards",
        image: {
            title: "audemars-piguet-hudson-yards-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Hudson Yards sellers",
        },
        description: "Sell your Audemars Piguet in Hudson Yards the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. Hudson Yards is a short ride from our 47th Street office, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Hudson Yards Sellers Choose InstaGold",
        description: "Hudson Yards sellers expect a modern, efficient, high-end experience.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Hudson Yards",
        description: "Hudson Yards is a short ride from our 47th Street office, so you can sell in person and get a fair, same-day offer. InstaGold is minutes from Hudson Yards, near Bryant Park and Times Square. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving Hudson Yards and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Hudson Yards sellers?", a: "Yes. Hudson Yards is minutes from Hudson Yards. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Hudson Yards Today",
