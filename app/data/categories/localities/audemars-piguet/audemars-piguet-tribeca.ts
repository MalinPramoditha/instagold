...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/tribeca
export const audemarsPiguetTribecaData = {
    meta: {
        title: "Sell Audemars Piguet Tribeca | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Tribeca with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/tribeca",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Tribeca",
        image: {
            title: "audemars-piguet-tribeca-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Tribeca sellers",
        },
        description: "Sell your Audemars Piguet in Tribeca the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. Tribeca sits just south of the Diamond District, so selling in person means no mailing, no waiting, and a real offer the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Tribeca",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Tribeca sellers?", a: "Yes. Tribeca is a quick trip from Tribeca up to the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Tribeca Today",
