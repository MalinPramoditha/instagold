...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/west-village
export const audemarsPiguetWestVillageData = {
    meta: {
        title: "Sell Audemars Piguet West Village | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in West Village with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
    ...
    hero: {
        eyebrow: "New York · West Village",
        title: "Sell Your Audemars Piguet in West Village",
        image: {
            title: "audemars-piguet-west-village-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving West Village sellers",
        },
        description: "Sell your Audemars Piguet in West Village the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From the West Village, our 47th Street office is a quick trip uptown, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why West Village Sellers Choose InstaGold",
        description: "West Village sellers value a personal, unhurried experience.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near West Village",
        description: "From the West Village, our 47th Street office is a quick trip uptown, so you can sell in person and get a fair, same-day offer. InstaGold is a short ride from the West Village up to the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving West Village and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from West Village sellers?", a: "Yes. West Village is a short ride from the West Village up to the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in West Village Today",
