...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/long-island-city
export const audemarsPiguetLongIslandCityData = {
    meta: {
        title: "Sell Audemars Piguet Long Island City | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Long Island City with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/long-island-city",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Long Island City",
        image: {
            title: "audemars-piguet-long-island-city-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Long Island City sellers",
        },
        description: "Sell your Audemars Piguet in Long Island City the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From Long Island City, our 47th Street office is a quick ride into Midtown, so you can sell in person on your schedule and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Long Island City",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Long Island City sellers?", a: "Yes. Long Island City is a short subway ride from Long Island City into Midtown and the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Long Island City Today",
