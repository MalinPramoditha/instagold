...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/upper-west-side
export const audemarsPiguetUpperWestSideData = {
    meta: {
        title: "Sell Audemars Piguet Upper West Side | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Upper West Side with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Upper West Side",
        image: {
            title: "audemars-piguet-upper-west-side-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Upper West Side sellers",
        },
        description: "Sell your Audemars Piguet in Upper West Side the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From the Upper West Side, our 47th Street office is a straight ride down, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Upper West Side",
        description: "From the Upper West Side, our 47th Street office is a straight ride down, so you can sell in person and get a fair, same-day offer. InstaGold is a direct ride from the Upper West Side down to the Diamond District, near Lincoln Center. Walk in during business hours or get an offer online first.",
        list: [
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Upper West Side sellers?", a: "Yes. Upper West Side is a direct ride from the Upper West Side down to the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Upper West Side Today",
