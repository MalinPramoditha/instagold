...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/dumbo
export const audemarsPiguetDumboData = {
    meta: {
        title: "Sell Audemars Piguet DUMBO | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in DUMBO with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/dumbo",
    ...
    hero: {
        eyebrow: "New York · DUMBO",
        title: "Sell Your Audemars Piguet in DUMBO",
        image: {
            title: "audemars-piguet-dumbo-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving DUMBO sellers",
        },
        description: "Sell your Audemars Piguet in DUMBO the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From DUMBO, our 47th Street office is a quick ride across the river, so you can sell in person instead of mailing it, and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why DUMBO Sellers Choose InstaGold",
        description: "DUMBO sellers appreciate a quick trip into the city for a real, in-person offer.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near DUMBO",
        description: "From DUMBO, our 47th Street office is a quick ride across the river, so you can sell in person instead of mailing it, and get paid the same day. InstaGold is a short subway ride from DUMBO into Manhattan and the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving DUMBO and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from DUMBO sellers?", a: "Yes. DUMBO is a short subway ride from DUMBO into Manhattan and the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in DUMBO Today",
