...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/financial-district
export const audemarsPiguetFinancialDistrictData = {
    meta: {
        title: "Sell Audemars Piguet Financial District | InstaGold",
        description: "Sell your Audemars Piguet in Financial District with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/financial-district",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Financial District",
        image: {
            title: "audemars-piguet-financial-district-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Financial District sellers",
        },
        description: "Sell your Audemars Piguet in Financial District the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From the Financial District, our 47th Street office is a straight subway ride uptown, so you can sell on a lunch break and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Financial District Sellers Choose InstaGold",
        description: "Financial District professionals move fast and expect a clean, no-nonsense transaction.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Financial District",
        description: "From the Financial District, our 47th Street office is a straight subway ride uptown, so you can sell on a lunch break and get paid the same day. InstaGold is a direct subway ride from the Financial District and Wall Street up to the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving Financial District and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Financial District sellers?", a: "Yes. Financial District is a direct subway ride from the Financial District and Wall Street up to the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Financial District Today",
