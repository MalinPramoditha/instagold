...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/murray-hill
export const audemarsPiguetMurrayHillData = {
    meta: {
        title: "Sell Audemars Piguet Murray Hill | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Murray Hill with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/murray-hill",
    ...
    hero: {
        eyebrow: "New York · Murray Hill",
        title: "Sell Your Audemars Piguet in Murray Hill",
        image: {
            title: "audemars-piguet-murray-hill-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Murray Hill sellers",
        },
        description: "Sell your Audemars Piguet in Murray Hill the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. Murray Hill is close to our 47th Street office, so selling in person is quick and you get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Murray Hill Sellers Choose InstaGold",
        description: "Murray Hill sellers want a fast, convenient, professional experience.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Murray Hill",
        description: "Murray Hill is close to our 47th Street office, so selling in person is quick and you get a fair, same-day offer. InstaGold is minutes from Murray Hill, near Grand Central Terminal. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving Murray Hill and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Murray Hill sellers?", a: "Yes. Murray Hill is minutes from Murray Hill. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Murray Hill Today",
