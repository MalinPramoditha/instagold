...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/chelsea
export const audemarsPiguetChelseaData = {
    meta: {
        title: "Sell Audemars Piguet Chelsea | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Chelsea with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Chelsea sellers?", a: "Yes. Chelsea is minutes from Chelsea. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Chelsea Today",
