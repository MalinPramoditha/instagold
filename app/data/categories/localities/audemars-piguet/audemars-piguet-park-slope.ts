...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/park-slope
export const audemarsPiguetParkSlopeData = {
    meta: {
        title: "Sell Audemars Piguet Park Slope | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Park Slope with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/park-slope",
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Park Slope",
        image: {
            title: "audemars-piguet-park-slope-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Park Slope sellers",
        },
        description: "Sell your Audemars Piguet in Park Slope the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From Park Slope, our 47th Street office is a direct ride into Manhattan, so you can sell in person and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Park Slope Sellers Choose InstaGold",
        description: "Park Slope sellers want a fair, family-friendly, no-pressure experience.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Park Slope",
        description: "From Park Slope, our 47th Street office is a direct ride into Manhattan, so you can sell in person and get paid the same day. InstaGold is a direct subway ride from Park Slope into Manhattan and the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving Park Slope and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Park Slope sellers?", a: "Yes. Park Slope is a direct subway ride from Park Slope into Manhattan and the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Park Slope Today",
