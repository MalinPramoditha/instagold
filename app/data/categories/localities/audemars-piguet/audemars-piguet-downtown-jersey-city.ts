...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/downtown-jersey-city
export const audemarsPiguetDowntownJerseyCityData = {
    meta: {
        title: "Sell Audemars Piguet Downtown Jersey City | InstaGold",
        description: "Sell your Audemars Piguet in Downtown Jersey City with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/downtown-jersey-city",
            ...
            areaServed: [
                { "@type": "Place", name: "Downtown Jersey City" },
    ...
    hero: {
        ...
        title: "Sell Your Audemars Piguet in Downtown Jersey City",
        image: {
            title: "audemars-piguet-downtown-jersey-city-hero",
            alt: "Audemars Piguet watches on stone at the InstaGold 47th Street office, serving Downtown Jersey City sellers",
        },
        description: "Sell your Audemars Piguet in Downtown Jersey City the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Royal Oak, Royal Oak Offshore, and every AP reference, with or without box and papers. From Downtown Jersey City, our 47th Street office is a quick PATH ride into Manhattan, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Downtown Jersey City Sellers Choose InstaGold",
        description: "Downtown Jersey City sellers value a short, convenient trip into Manhattan for a real offer.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Audemars Piguet Near Downtown Jersey City",
        description: "From Downtown Jersey City, our 47th Street office is a quick PATH ride into Manhattan, so you can sell in person and get a fair, same-day offer. InstaGold is a quick PATH ride from Downtown Jersey City into Manhattan and the Diamond District. Walk in during business hours or get an offer online first.",
        list: [
            "Prime Diamond District location: 31 W 47th Street, Suite 202",
            "Serving Downtown Jersey City and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Downtown Jersey City sellers?", a: "Yes. Downtown Jersey City is a quick PATH ride from Downtown Jersey City into Manhattan and the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Downtown Jersey City Today",
