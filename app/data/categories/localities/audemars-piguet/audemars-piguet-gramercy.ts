...
// Audemars Piguet locality page - route: /sell-audemars-piguet-nyc/gramercy
export const audemarsPiguetGramercyData = {
    meta: {
        title: "Sell Audemars Piguet Gramercy | Top Cash | InstaGold",
        description: "Sell your Audemars Piguet in Gramercy with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-audemars-piguet-nyc/gramercy",
    ...
    faqs: [
        { q: "Do you buy Audemars Piguet watches from Gramercy sellers?", a: "Yes. Gramercy is a short ride from Gramercy up to the Diamond District. Bring your Audemars Piguet in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Audemars Piguet in Gramercy Today",
