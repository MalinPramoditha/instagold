...
// Cartier locality page - route: /sell-cartier-nyc/park-slope
export const cartierParkSlopeData = {
    meta: {
        title: "Sell Cartier Park Slope | Top Cash | InstaGold",
        description: "Sell your Cartier in Park Slope with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/park-slope",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Park Slope",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Park Slope sellers?", a: "Yes. Park Slope is a direct subway ride from Park Slope into Manhattan and the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Park Slope Today",
