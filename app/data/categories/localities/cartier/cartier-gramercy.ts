...
// Cartier locality page - route: /sell-cartier-nyc/gramercy
export const cartierGramercyData = {
    meta: {
        title: "Sell Cartier Gramercy | Top Cash | InstaGold",
        description: "Sell your Cartier in Gramercy with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/gramercy",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Gramercy",
        image: {
            title: "cartier-gramercy-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Gramercy sellers",
        },
        description: "Sell your Cartier in Gramercy the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. Gramercy is a short trip from our 47th Street office, so you can sell in person, explore your options with no pressure, and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    companyDetails: {
        ...
        title: "Why Gramercy Sellers Choose InstaGold",
        description: "Gramercy sellers often take their time, and we offer a comfortable, no-pressure appraisal.",
        items: [
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Gramercy",
        ...
        list: [
            ...
            "Serving Gramercy and the greater NYC area",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Gramercy sellers?", a: "Yes. Gramercy is a short ride from Gramercy up to the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Gramercy Today",
