...
// Cartier locality page - route: /sell-cartier-nyc/lincoln-square
export const cartierLincolnSquareData = {
    meta: {
        title: "Sell Cartier Lincoln Square | Top Cash | InstaGold",
        description: "Sell your Cartier in Lincoln Square with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/lincoln-square",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Lincoln Square",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Lincoln Square sellers?", a: "Yes. Lincoln Square is a direct ride from Lincoln Square. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Lincoln Square Today",
