...
// Cartier locality page - route: /sell-cartier-nyc/midtown-east
export const cartierMidtownEastData = {
    meta: {
        title: "Sell Cartier Midtown East | Top Cash | InstaGold",
        description: "Sell your Cartier in Midtown East with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/midtown-east",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Midtown East",
        image: {
            title: "cartier-midtown-east-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Midtown East sellers",
        },
        description: "Sell your Cartier in Midtown East the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. Midtown East is right beside our 47th Street office, so you can sell in person in minutes and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Midtown East",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Midtown East sellers?", a: "Yes. Midtown East is a few blocks from Midtown East. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Midtown East Today",
