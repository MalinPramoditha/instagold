...
// Cartier locality page - route: /sell-cartier-nyc/hoboken
export const cartierHobokenData = {
    meta: {
        title: "Sell Cartier Hoboken | Top Cash | InstaGold",
        description: "Sell your Cartier in Hoboken with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/hoboken",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Hoboken",
        image: {
            title: "cartier-hoboken-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Hoboken sellers",
        },
        description: "Sell your Cartier in Hoboken the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. From Hoboken, our 47th Street office is a quick PATH ride into Manhattan, so you can sell in person instead of mailing it, and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Hoboken",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Hoboken sellers?", a: "Yes. Hoboken is a quick PATH ride from Hoboken into Manhattan and the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Hoboken Today",
