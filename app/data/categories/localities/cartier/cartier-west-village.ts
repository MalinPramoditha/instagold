...
// Cartier locality page - route: /sell-cartier-nyc/west-village
export const cartierWestVillageData = {
    meta: {
        title: "Sell Cartier West Village | Top Cash | InstaGold",
        description: "Sell your Cartier in West Village with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/west-village",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in West Village",
        image: {
            title: "cartier-west-village-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving West Village sellers",
        },
        description: "Sell your Cartier in West Village the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. From the West Village, our 47th Street office is a quick trip uptown, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near West Village",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from West Village sellers?", a: "Yes. West Village is a short ride from the West Village up to the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in West Village Today",
