...
// Cartier locality page - route: /sell-cartier-nyc/soho
export const cartierSohoData = {
    meta: {
        title: "Sell Cartier SoHo | Top Cash | InstaGold",
        description: "Sell your Cartier in SoHo with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/soho",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in SoHo",
        image: {
            title: "cartier-soho-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving SoHo sellers",
        },
        description: "Sell your Cartier in SoHo the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. From SoHo, our 47th Street office is a quick trip uptown, so you can sell face to face and get a fair, same-day offer instead of mailing it away. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near SoHo",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from SoHo sellers?", a: "Yes. SoHo is a short ride from SoHo up to the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in SoHo Today",
