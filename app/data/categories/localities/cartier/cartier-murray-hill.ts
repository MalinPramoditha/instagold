...
// Cartier locality page - route: /sell-cartier-nyc/murray-hill
export const cartierMurrayHillData = {
    meta: {
        title: "Sell Cartier Murray Hill | Top Cash | InstaGold",
        description: "Sell your Cartier in Murray Hill with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/murray-hill",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Murray Hill",
        image: {
            title: "cartier-murray-hill-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Murray Hill sellers",
        },
        description: "Sell your Cartier in Murray Hill the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. Murray Hill is close to our 47th Street office, so selling in person is quick and you get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Murray Hill",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Murray Hill sellers?", a: "Yes. Murray Hill is minutes from Murray Hill. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Murray Hill Today",
