...
// Cartier locality page - route: /sell-cartier-nyc/chelsea
export const cartierChelseaData = {
    meta: {
        title: "Sell Cartier Chelsea | Top Cash | InstaGold",
        description: "Sell your Cartier in Chelsea with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/chelsea",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Chelsea",
        image: {
            title: "cartier-chelsea-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Chelsea sellers",
        },
        description: "Sell your Cartier in Chelsea the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. Chelsea is a short hop from our 47th Street office, so you can sell in person, see the appraisal, and walk out paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Chelsea",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Chelsea sellers?", a: "Yes. Chelsea is minutes from Chelsea. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Chelsea Today",
