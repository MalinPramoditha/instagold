...
// Cartier locality page - route: /sell-cartier-nyc/brooklyn-heights
export const cartierBrooklynHeightsData = {
    meta: {
        title: "Sell Cartier Brooklyn Heights | Top Cash | InstaGold",
        description: "Sell your Cartier in Brooklyn Heights with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/brooklyn-heights",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Brooklyn Heights sellers?", a: "Yes. Brooklyn Heights is a short subway ride from Brooklyn Heights into Manhattan and the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Brooklyn Heights Today",
