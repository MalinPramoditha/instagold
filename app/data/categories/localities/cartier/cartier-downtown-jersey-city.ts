...
// Cartier locality page - route: /sell-cartier-nyc/downtown-jersey-city
export const cartierDowntownJerseyCityData = {
    meta: {
        title: "Sell Cartier Downtown Jersey City | Top Cash | InstaGold",
        description: "Sell your Cartier in Downtown Jersey City with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/downtown-jersey-city",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Downtown Jersey City",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Downtown Jersey City sellers?", a: "Yes. Downtown Jersey City is a quick PATH ride from Downtown Jersey City into Manhattan and the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Downtown Jersey City Today",
