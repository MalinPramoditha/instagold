...
// Cartier locality page - route: /sell-cartier-nyc/upper-west-side
export const cartierUpperWestSideData = {
    meta: {
        title: "Sell Cartier Upper West Side | Top Cash | InstaGold",
        description: "Sell your Cartier in Upper West Side with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/upper-west-side",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Upper West Side",
        image: {
            title: "cartier-upper-west-side-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Upper West Side sellers",
        },
        description: "Sell your Cartier in Upper West Side the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. From the Upper West Side, our 47th Street office is a straight ride down, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Upper West Side",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Upper West Side sellers?", a: "Yes. Upper West Side is a direct ride from the Upper West Side down to the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Upper West Side Today",
