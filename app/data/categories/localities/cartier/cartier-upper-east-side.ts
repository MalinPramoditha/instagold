...
// Cartier locality page - route: /sell-cartier-nyc/upper-east-side
export const cartierUpperEastSideData = {
    meta: {
        title: "Sell Cartier Upper East Side | Top Cash | InstaGold",
        description: "Sell your Cartier in Upper East Side with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/upper-east-side",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Upper East Side",
        image: {
            title: "cartier-upper-east-side-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Upper East Side sellers",
        },
        description: "Sell your Cartier in Upper East Side the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. From the Upper East Side, our 47th Street office is a short ride down, so you can sell in person and get a fair, same-day offer. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Upper East Side",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Upper East Side sellers?", a: "Yes. Upper East Side is a direct ride from the Upper East Side down to the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Upper East Side Today",
