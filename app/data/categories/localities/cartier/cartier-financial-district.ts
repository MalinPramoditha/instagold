...
// Cartier locality page - route: /sell-cartier-nyc/financial-district
export const cartierFinancialDistrictData = {
    meta: {
        title: "Sell Cartier Financial District | Top Cash | InstaGold",
        description: "Sell your Cartier in Financial District with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/financial-district",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in Financial District",
        image: {
            title: "cartier-financial-district-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving Financial District sellers",
        },
        description: "Sell your Cartier in Financial District the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. From the Financial District, our 47th Street office is a straight subway ride uptown, so you can sell on a lunch break and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Financial District",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Financial District sellers?", a: "Yes. Financial District is a direct subway ride from the Financial District and Wall Street up to the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Financial District Today",
