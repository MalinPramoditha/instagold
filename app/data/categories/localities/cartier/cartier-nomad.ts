...
// Cartier locality page - route: /sell-cartier-nyc/nomad
export const cartierNomadData = {
    meta: {
        title: "Sell Cartier NoMad | Top Cash | InstaGold",
        description: "Sell your Cartier in NoMad with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/nomad",
    ...
    hero: {
        ...
        title: "Sell Your Cartier in NoMad",
        image: {
            title: "cartier-nomad-hero",
            alt: "Cartier watches on stone at the InstaGold 47th Street office, serving NoMad sellers",
        },
        description: "Sell your Cartier in NoMad the smart way with InstaGold. We are a licensed watch buyer on 47th Street in the Diamond District, paying top cash for Santos, Tank, Ballon Bleu, and every Cartier reference, with or without box and papers. NoMad is a short walk or ride from our 47th Street office, so you can sell in person, watch the evaluation, and get paid the same day. We authenticate and value your watch in front of you and pay the same day. No appointment needed. No obligation to sell.",
    },
    process: {
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near NoMad",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from NoMad sellers?", a: "Yes. NoMad is minutes from NoMad. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in NoMad Today",
