...
// Cartier locality page - route: /sell-cartier-nyc/flatiron-district
export const cartierFlatironDistrictData = {
    meta: {
        title: "Sell Cartier Flatiron District | Top Cash | InstaGold",
        description: "Sell your Cartier in Flatiron District with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/flatiron-district",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near Flatiron District",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from Flatiron District sellers?", a: "Yes. Flatiron District is minutes from the Flatiron District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in Flatiron District Today",
