...
// Cartier locality page - route: /sell-cartier-nyc/dumbo
export const cartierDumboData = {
    meta: {
        title: "Sell Cartier DUMBO | Top Cash | InstaGold",
        description: "Sell your Cartier in DUMBO with InstaGold. Licensed 47th St buyer paying top cash, expert valuation, paid same day. Free offer fast.",
    },
    schema: [
        {
            ...
            "@type": "LocalBusiness",
            name: "InstaGold",
            url: "https://lux-offer-pro.lovable.app/sell-cartier-nyc/dumbo",
    ...
    location: {
        ...
        eyebrow: "Location",
        title: "Where to Sell a Cartier Near DUMBO",
    ...
    faqs: [
        { q: "Do you buy Cartier watches from DUMBO sellers?", a: "Yes. DUMBO is a short subway ride from DUMBO into Manhattan and the Diamond District. Bring your Cartier in for a free, same-day appraisal, or get an offer online first." },
    ...
    cta: {
        title: "Sell Your Cartier in DUMBO Today",
