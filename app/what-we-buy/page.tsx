...
const CARDS = [
    ...
    { name: "Scrap & Dental Gold", descriptor: "Any karat, any form", href: "/cash-for-gold-nyc", alt: "Scrap gold icon", icon: "Recycle" },
    { name: "Luxury Watches", descriptor: "All major brands", href: "/sell-used-watch-nyc", alt: "Luxury watch icon", icon: "Watch" },
    { name: "Rolex", descriptor: "Every model", href: "/sell-used-watch-nyc", alt: "Rolex watch icon", icon: "Crown" },
    { name: "Patek Philippe", descriptor: "Nautilus and more", href: "/sell-used-watch-nyc", alt: "Patek Philippe watch icon", icon: "Watch" },
    { name: "Audemars Piguet", descriptor: "Royal Oak and more", href: "/sell-used-watch-nyc", alt: "Audemars Piguet watch icon", icon: "Watch" },
